...
@threestudio.register("implicit-volume-clothes")
class ImplicitVolume(BaseImplicitGeometry):
    ...
    def get_activated_density(
        ...
        if self.cfg.density_bias == "blob_dreamfusion":
            ...
            if not (self.cfg.density_bias_center == 0):
        ...
        raw_density: Float[Tensor, "*N 1"] = (
            density + density_bias * smpl_density_bias_multiplier
        )
