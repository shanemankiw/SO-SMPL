...
class SMPLXSeg:
    ...
    shoe_mask = np.load(f"{smplx_dir}/shoes_mask.npy")
    ...
    def __init__(
        ...
        if hip_values is not None:
            ...
            if clothes_type == "upper-long":
                ...
                mask_tensor[SMPLXSeg.shoe_mask > 0.5] = scale_init
...
class ClothesDisplacement(nn.Module):
    def __init__(
        ...
        if clothes_type == "upper-long":
            ...
            target_ids = SMPLXSeg.shoe_mask > 0.5
...
class SMPLPlusClothes(BaseExplicitGeometry):
    ...
    def isosurface(self, clothes_only=False) -> Mesh:
        ...
        if self.cfg.clothes_type == "shoes":
            ...
            clothed_human.add_extra("shoes_mesh", shoes_mesh)
    ...
    def isosurface_inputclothes_wbetas(
        self,
        input_v_pos_base,
        input_clothes_disp,
        input_v_pos_betas,
        ...
        **kwargs,
        ...
        if isinstance(other, SMPLPlus):
            ...
            if instance.cfg.clothes_type == "upper-long":
                ...
                instance.clothes_vertices_scale[SMPLXSeg.shoe_mask > 0.5] = 1.0
