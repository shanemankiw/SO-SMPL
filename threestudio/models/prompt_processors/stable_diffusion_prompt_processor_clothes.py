...
import threestudio
from threestudio.models.prompt_processors.base_clothes import (
    PromptProcessor,
    hash_prompt,
)
...
@threestudio.register("stable-diffusion-prompt-processor-clothes")
class StableDiffusionPromptProcessor(PromptProcessor):
    ...
    def spawn_func(pretrained_model_name_or_path, prompts, cache_dir):
        ...
        with torch.no_grad():
            ...
            # (NOTE) add this line if on 3090 environment, because of the device mismatch.
