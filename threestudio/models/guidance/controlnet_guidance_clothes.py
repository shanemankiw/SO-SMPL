...
@threestudio.register("controlnet-clothes-guidance")
class StableDiffusionGuidance(BaseObject):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if self.cfg.use_sjc:
            grad = self.compute_grad_sjc(latents, control_signals, text_embeddings, t)
        else:
            grad = self.compute_grad_sds(latents, control_signals, text_embeddings, t)
