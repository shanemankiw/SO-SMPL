    ...
    def __call__(
        ...
        **kwargs,
        ...
        if mix_mode:
            ...
            latent_normal = F.interpolate(
                rgb.permute(0, 3, 1, 2), (64, 64), mode="bilinear", align_corners=False
            )
            latent_aux = F.interpolate(
                rgb_aux.permute(0, 3, 1, 2),
                (64, 64),
                mode="bilinear",
                align_corners=False,
            )
            ...
            rgb_BCHW = (
                rgb_BCHW * 2.0 - 1.0
            )  # scale to [-1, 1] to match the diffusion range
