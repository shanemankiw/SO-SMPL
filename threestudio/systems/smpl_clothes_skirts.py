...
@threestudio.register("smpl-clothes-skirts-system")
class ProlificDreamer(BaseLift3DSystem):
    ...
    def forward(self, batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        render_out = {
            ...
            "skirts_mesh": clothes_out["mesh"].extras["skirts_mesh"],
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.C(self.cfg.loss.lambda_normal_consistency) > 0:
            loss_normal_consistency = out["skirts_mesh"].normal_consistency()
        ...
        if self.C(self.cfg.loss.lambda_laplacian_smoothness) > 0:
            loss_laplacian_smoothness = out["skirts_mesh"].laplacian()
