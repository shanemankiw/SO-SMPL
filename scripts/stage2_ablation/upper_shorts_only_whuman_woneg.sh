...
prompts_upper=(
    "a beautiful thin caucasian teenage girl in a pastel yellow tee with short sleeves, marvelous designer clothes asset"
    # "a beautiful curvaceous african-american woman in a coral colored top with short sleeves,  marvelous designer clothes asset"
    # "a beautiful Chinese mature woman in a jade green blouse with short sleeves, marvelous designer clothes asset"
    # "a beautiful voluptuous Hispanic girl in a cherry red crop top with short sleeves, marvelous designer clothes asset"
    # "a fat old lady in a soft lavender blouse with short sleeves, marvelous designer clothes asset"
    "a tall fat old bald man in a sand colored polo shirt with short sleeves, marvelous designer clothes asset"
    "a strong Hispanic man in a cobalt blue t-shirt with short sleeves, marvelous designer clothes asset"
    "a thin caucasian teenage boy in a mint green polo shirt with short sleeves, marvelous designer clothes asset"
    # "an african-american man in a striped black and white tee with short sleeves, marvelous designer clothes asset"
    "a cute Asian man in a heather gray top with short sleeves, marvelous designer clothes asset"
)
...
tags_upper=(
    "female-caucasian-redo-shortcomb1-upper-short-woneg-yellow-tee"
    # "female-africanamerican-shortcomb1-upper-short-woneg-coral-top"
    # "female-chinese-shortcomb1-upper-short-woneg-jade-blouse"
    # "female-hispanic-shortcomb1-upper-short-woneg-red-croptop"
    # "female-old-shortcomb1-upper-short-woneg-lavender-blouse"
    "male-old-shortcomb1-upper-short-woneg-sand-polo"
    "male-hispanic-shortcomb1-upper-short-woneg-cobalt-tshirt"
    "male-caucasian-shortcomb1-upper-short-woneg-mint-polo-nohumanstream"
    # "male-africanamerican-shortcomb1-upper-short-woneg-striped-tee"
    "male-asian-shortcomb1-upper-short-woneg-heather-top"
)
...
for i in "${!clothes_prompts_upper[@]}"; do
    ...
    python3 launch.py --config configs/smplplus-clothes.yaml --train \
        ...
        system.loss.lambda_disp_reg=3000.0 \
