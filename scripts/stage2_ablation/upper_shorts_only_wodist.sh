...
folder_name="Stage2-1110-ablation-nodist"
...
tags_upper=(
    # "female-caucasian-shortcomb1-upper-short-woalbedo-yellow-tee"
    # "female-africanamerican-shortcomb1-upper-short-woalbedo-coral-top"
    # "female-chinese-shortcomb1-upper-short-woalbedo-jade-blouse"
    # "female-hispanic-shortcomb1-upper-short-woalbedo-red-croptop"
    # "female-old-shortcomb1-upper-short-woalbedo-lavender-blouse"
    # "male-old-shortcomb1-upper-short-woalbedo-sand-polo"
    # "male-hispanic-shortcomb1-upper-short-woalbedo-cobalt-tshirt"
    # "male-caucasian-shortcomb1-upper-short-woalbedo-mint-polo-nohumanstream"
    # "male-africanamerican-shortcomb1-upper-short-woalbedo-striped-tee"
    "male-asian-shortcomb1-upper-short-woalbedo-heather-top"
)
...
for i in "${!clothes_prompts_upper[@]}"; do
    ...
    python3 launch.py --config configs/smplplus-clothes-noalbedo.yaml --train \
        ...
        tag="${tags_upper[$i]}_cfg25_alb0k_norm10k_lap10k" \
        use_timestamp=false \
        data.batch_size=1 \
        data.up_bias=0.15 \
